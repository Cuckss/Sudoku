...
public class SUDOKU_FRAME extends javax.swing.JFrame {
    ...
    private void seeSolution(){
        JButton predefinedBtns []={r2c1,r3c1,r3c3,r1c4,r2c5,r2c6,r3c5,r1c7,
            r1c8,r1c9,r2c7,r2c9,r3c8,r5c2,r5c3,r6c2,r4c5,r4c6,r6c4,r6c5,r5c7,
            r4c8,r5c8,r7c2,r8c1,r9c1,r9c2,r9c3,r8c4,r7c5,r8c5,r9c6,r7c7,r7c9,
            r8c9};
        JButton btns[][]={
    ...
    private void checkMoves(){
        ...
        for(int i=0;i<9;i++){
            for(int j=0;j<9;j++){
                if(!btns[i][j].getText().equals(solvedBoard[i][j]) && btns[i][j].getText()!=""){
    ...
    private void initComponents() {
        ...
        Resetbtn.setBackground(new java.awt.Color(153, 51, 255));
        ...
        Undobtn.setBackground(new java.awt.Color(0, 255, 204));
    ...
    private void r4c5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r4c5ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "This place is already been allocated", "Suduko game", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void ExitbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExitbtnActionPerformed
      if(JOptionPane.showConfirmDialog(this, "confirm if you want to exit?", "Suduko game", JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION){
          System.exit(0);
      }
